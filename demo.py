...
DEMO_PAIRS = [
    ...
    ("BTC/USD", "BUY",  67842.0, 66100.0, 71326.0, 8.4, "HIGH",   "CRYPTO"),
    ("ETH/USD", "BUY",  3124.50, 3050.00, 3273.50, 7.6, "MEDIUM", "CRYPTO"),
    ("USD/CAD", "SELL", 1.36120, 1.36650, 1.35060, 7.4, "MEDIUM", "FOREX"),
]
...
def format_demo_signal(sig, index: int, total: int) -> str:
    ...
    return (
        ...
        f"📝 *Confirmations:*\n{reasons}\n\n"
        f"🕐 _{now}_\n"
        f"📌 _Demo Signal {index}/{total} — Live signals fire on weekdays_"
    )