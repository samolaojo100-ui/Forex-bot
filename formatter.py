...
def format_signal(sig, index: int = 1, total: int = 1) -> str:
    ...
    return (
        f"━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"{d_emoji} {sig.pair} -- {sig.direction}\n"
        f"Time: {now}\n"
        f"Confidence: {c_emoji} {sig.confidence} -- {sig.tfs_agreed} of {sig.total_tfs} TFs agree\n"
        f"Score: {sig.score} of 25 | {a_label}\n"
        f"Risk: ${sig.risk_amount} (1% of balance)\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━\n\n"
        f"{tf_blocks}\n\n"
        f"━━━━━━━━━━━━━━━━━━━━━━━\n"
        f"Signal {index} of {total}"
    )
...
def format_scanning(crypto_only: bool = False) -> str:
    ...
    return (
        f"🔄 Scanning {scope}...\n\n"
        f"Running 5 timeframes x 5 indicators per pair.\n\n"
